 ...
 */
final class Version20230111151842 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE rent (id INT AUTO_INCREMENT NOT NULL, end_date DATE NOT NULL, start_date DATE NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE rent_car (rent_id INT NOT NULL, car_id INT NOT NULL, INDEX IDX_77672298E5FD6250 (rent_id), INDEX IDX_77672298C3C6F69F (car_id), PRIMARY KEY(rent_id, car_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE rent_car ADD CONSTRAINT FK_77672298E5FD6250 FOREIGN KEY (rent_id) REFERENCES rent (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE rent_car ADD CONSTRAINT FK_77672298C3C6F69F FOREIGN KEY (car_id) REFERENCES car (id) ON DELETE CASCADE');
    }
